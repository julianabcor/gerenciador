...
Média aritmética (formatada com duas casas decimais).
...
Digite sair para encerrar a entrada e visualizar os resultados.
Saída esperada:
text
Gerenciador de números
Número (ou 'sair'): 10
...
Lista: [10.0, 20.0, 30.0]
Soma: 60.0
Média: 20.00
Maior: 30.0 | Menor: 10.0
Use o código com cuidado.
